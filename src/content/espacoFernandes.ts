...
export const espacoFernandes: EspacoFernandesContent = {
  seo: {
    ...
    description:
      "Espaço privativo para aniversários, confraternizações e dias de lazer em Formosa, Uibaí, com piscina, área gourmet, churrasqueira, sinuca e Wi-Fi. Consulte a disponibilidade pelo WhatsApp.",
    canonicalUrl:
  ...
  hero: {
    ...
    title: "Piscina, lazer e privacidade para celebrar em Formosa",
    description:
  ...
  about: {
    ...
    title: "Privacidade para reunir quem importa",
    text: "O Espaço Fernandes recebe aniversários, confraternizações, encontros em família e dias de lazer em um ambiente reservado em Formosa, Uibaí.",
  },
  structure: {
    id: "estrutura",
    eyebrow: "Estrutura e lazer",
    title: "Piscina, área gourmet e lazer no mesmo ambiente",
    description:
      "A estrutura reúne piscina, área gourmet, churrasqueira, freezer, mesa de sinuca, TV, jogos e Wi-Fi para aproveitar a diária.",
    featuredImage: {
  ...
  chalet: {
    ...
    text: "O chalé oferece um ambiente reservado para pausas e descanso durante a diária.",
    image: {
      src: `${imageBase}/real/chale-entrada-01.webp`,
    ...
    items: [
      {
        ...
        answer: "A locação é feita por diária. Consulte pelo WhatsApp a disponibilidade, os horários, o valor e as condições de reserva.",
        visible: true,
        order: 1,
      },
      {
      ...
      },
      {
        id: "wifi",
        question: "Tem Wi-Fi?",
        answer: "Sim. O espaço conta com conexão Wi-Fi disponível durante a diária.",
        visible: true,
        order: 4,
      },
      {
        ...
        answer: "Sim. A churrasqueira está integrada à área gourmet.",
        visible: true,
        order: 5,
      },
      {
        ...
        answer:
          "Entre em contato pelo WhatsApp para verificar a disponibilidade na data desejada.",
        visible: true,
        order: 6,
      },
      {
